...
% Students
  ...
  Eslam Yasser Abdel Nabi\\ [0.3em]
  
  Ziad Mohammed Daif\\[0.3em]
  
  Hazem Gamal Abu Zaid
...
Arch Considered one of the most challenging distributions, Arch is primarily aimed at professional programmers and power users. It follows a do-it-yourself philosophy, which means the system comes with bare bones. Users must create and customize their systems entirely themselves, including installing the graphical user interface (GUI) and network managers.
...
\begin{enumerate}
    ...
    \item Command lines. \href{https://www.digitalocean.com/community/tutorials/linux-commands}{ Digital ocaen }
    \item Historical store. \href{https://en.wikipedia.org/wiki/Linus_Torvalds}{ Wikipedia }
    \item Information about Linux. \href{https://kernel.org/category/about.html}{ Kernel }
    \item The Linux Kernel documentation. \href{https://kernel.org/doc/html/latest/}{ kernel }
    \item Information about distributions. \href{https://distrowatch.com/}{ Distrowatch }
